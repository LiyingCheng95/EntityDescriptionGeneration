...
class GraphConvolution:
    ...
    def __init__(self,
        ...
        self._att_weight = mx.symbol.Variable(self._prefix + "_" + str(j) + "_weight",
                                                     shape=(self._direction_num, self._direction_num))
        ...
        self._direct_W = mx.symbol.Variable(self._prefix + '_direct_weight',
                                             shape=(self._hidden_dim * self._multi_heads,  self._hidden_dim))
