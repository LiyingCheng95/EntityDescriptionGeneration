...
class CheckpointDecoder:
    ...
    def decode_and_evaluate(self,
        ...
        with data_io.smart_open(output_name, 'w') as output:
            ...
            for i, (inputs, graph) in enumerate(zip(self.inputs_sentences, self.graph)):
                trans_inputs.append(sockeye.inference.make_input_from_multiple_strings(i, inputs, graph, edge_vocab))
