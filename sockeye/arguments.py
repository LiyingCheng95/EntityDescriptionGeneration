...
def add_training_data_args(params, required=False):
    ...
    params.add_argument('--source-graphs', '-smg',
                        required=False,
                        default=None,
                        help='Source side graphs for GCN encoder (training)')
    params.add_argument('--edge-vocab',
                        required=False,
                        default=None,
...
def add_validation_data_params(params):
    ...
    params.add_argument('--val-source-graphs', '-vsmg',
                        required=False,
                        default=None,
...
def add_model_parameters(params):
    ...
    model_params.add_argument('--gcn-dropout',
                              type=float,
                              default=0.0,
    ...
    model_params.add_argument('--gcn-num-layers',
                              ...
                              default=3,
                              help='Number of GCN hidden units for encoder (use only with --use-gcn). Default: %(default)s.')
    model_params.add_argument('--gcn-adj-norm',
                              action="store_true",
                              help="Activate residual connections between GCN layers. Ignored if GCN layers < 2")
    model_params.add_argument('--gcn-positional-embedding-type',
                              choices=C.POSITIONAL_EMBEDDING_TYPES,
